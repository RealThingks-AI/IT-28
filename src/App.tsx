...
const AssetSetup = lazy(() => import("./pages/helpdesk/assets/setup"));
...
const AssetsTools = lazy(() => import("./pages/helpdesk/assets/tools"));
const AssetsFieldsSetup = lazy(() => import("./pages/helpdesk/assets/setup/fields-setup"));
