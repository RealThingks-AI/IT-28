...
import { FALLBACK_NAV, getPhotoUrl, useAssetPageShortcuts } from "@/lib/assetHelpers";
...
const CheckoutPage = () => {
  ...
  // getPhotoUrl imported from assetHelpers

  // Fetch available assets via shared hook
  const { data: assets = [], isLoading, isError, refetch, isStaleSearch: _isStaleSearch } = useAvailableAssets({
    status: "available",
    search,
  ...
  const isStaleSearch = _isStaleSearch;
    ...
    <div className="h-full flex flex-col bg-background overflow-hidden">
      <div className="flex-1 min-h-0 overflow-hidden p-3">
        <div className="flex gap-3 h-full">
          ...
          {/* Right Column */}
          <div className="w-[340px] flex-shrink-0 flex flex-col gap-3 overflow-y-auto max-h-full">
            {/* Checkout Form */}
