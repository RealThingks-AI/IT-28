          ...
          <CardContent className="pt-3 space-y-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Select value={employeeRoleFilter} onValueChange={(v) => { setEmployeeRoleFilter(v); setEmployeePage(1); }}>
                <SelectTrigger className="w-[130px] h-7 text-xs"><SelectValue placeholder="All Roles" /></SelectTrigger>
                <SelectContent>
              ...
              <Select value={employeeStatusFilter} onValueChange={(v) => { setEmployeeStatusFilter(v); setEmployeePage(1); }}>
                <SelectTrigger className="w-[130px] h-7 text-xs"><SelectValue placeholder="All Status" /></SelectTrigger>
                <SelectContent>
              ...
              <div className="ml-auto flex gap-1.5">
                ...
                <Button size="sm" variant="outline" className="h-7 text-xs" onClick={() => window.open("/admin/users", "_blank")}>
            ...
            <Table wrapperClassName="border rounded-lg">
              <TableHeader className="bg-muted/50">
                <TableRow className="hover:bg-transparent">
                  ...
                  <TableHead className="font-medium text-xs uppercase text-muted-foreground w-[60px]">Actions</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {loadingEmployees ? (
