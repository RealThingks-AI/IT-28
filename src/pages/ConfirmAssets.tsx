...
export default function ConfirmAssets() {
    ...
    (async () => {
      try {
        ...
        json.items.forEach((item: ConfirmationItem) => {
          initial[item.id] = { response: item.response as "confirmed" | "denied" || "confirmed" };
        });
  ...
  const deniedWithoutReason = data?.items.some(
    item => responses[item.id]?.response === "denied" && !responses[item.id]?.deny_reason?.trim()
  );
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            <p className="text-sm text-gray-500">
              ...
              A reason is required for denied assets.
            </p>
            ...
            <div className="pt-4 border-t flex items-center justify-between">
              ...
              <Button
                ...
                disabled={!allResponded || !!deniedWithoutReason || submitting}
