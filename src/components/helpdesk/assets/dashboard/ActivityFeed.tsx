...
const feedColumnHeaders: Record<string, { col1: string; col2: string; col3: string; col4: string }> = {
  checkedin: { col1: "#", col2: "Asset Tag", col3: "User", col4: "Date" },
  checkedout: { col1: "#", col2: "Asset Tag", col3: "User", col4: "Date" },
...
export function ActivityFeed({
  ...
  }), [recentCheckins, recentCheckouts, activeRepairs, newAssets, disposedAssets, lostAssets]);
  ...
  return (
    <Card className="animate-fade-in flex flex-col min-h-[400px]" style={{ animationDelay: "80ms", animationDuration: "350ms", animationFillMode: "backwards" }}>
